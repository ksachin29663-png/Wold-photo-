...
export const searchImages = async (params?: SearchImagesParams, options?: RequestInit): Promise<SearchResults> => {
  ...
  return customFetch<SearchResults>(getSearchImagesUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getSearchImagesQueryOptions = <TData = Awaited<ReturnType<typeof searchImages>>, TError = ErrorType<ErrorResponse>>(params?: SearchImagesParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof searchImages>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
